    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-6">
        ...
        <div className="flex gap-4">
          ...
          <button className="border border-purple-500 text-purple-400 hover:bg-purple-900 px-6 py-3 rounded-xl font-semibold">
            See Demo
          </button>
        </div>
      </section>
      ...
      <section className="py-20 px-6 text-center bg-gradient-to-b from-zinc-950 to-black">
        ...
        <button className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg">
          Get Started Free
        </button>
      </section>
